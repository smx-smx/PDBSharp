		...
		private ISymbolSerializer? CreateSymbolSerializer(SymbolHeader hdr) {
			...
			switch (hdr.Type) { 
				...
				case SymbolType.S_BLOCK32:
					return new Symbols.S_BLOCK32.Serializer(ctx, subStream); 
				...
				case SymbolType.S_INLINESITE:
					return new Symbols.S_INLINESITE.Serializer(ctx, subStream); 
				...
				case SymbolType.S_GMANPROC:
					return new Symbols.S_GMANPROC.Serializer(ctx, subStream); 
				case SymbolType.S_LMANPROC:
				case SymbolType.S_LMANPROC_ST:
					return new Symbols.S_LMANPROC.Serializer(ctx, subStream); 
				case SymbolType.S_GPROC32:
				case SymbolType.S_GPROC32_ST:
					return new Symbols.S_GPROC32.Serializer(ctx, subStream); 
				case SymbolType.S_LPROC32:
				case SymbolType.S_LPROC32_ST:
					return new Symbols.S_LPROC32.Serializer(ctx, subStream);
				...
				case SymbolType.S_SEPCODE:
					return new Symbols.S_SEPCODE.Serializer(ctx, subStream);
				case SymbolType.S_THUNK32:
				case SymbolType.S_THUNK32_ST:
					return new Symbols.S_THUNK32.Serializer(ctx, subStream); 
				...
				case SymbolType.S_WITH32_ST:
					return new Symbols.S_WITH32.Serializer(ctx, subStream);
